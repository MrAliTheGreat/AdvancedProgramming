...
std::string TV::get_product_info_html(){
	std::string product_info = "";
	product_info += "  <tr>";
	product_info += "    <th>Screen Size</th>";
	product_info += "    <th>" + std::to_string(display_size) + "</th>";
	product_info += "  </tr>";
	product_info += "  <tr>";
	product_info += "    <th>Screen Type</th>";
	product_info += "    <th>" + screen_type + "</th>";
	product_info += "  </tr>";
	product_info += "  <tr>";
	product_info += "    <th>Resolution</th>";
	product_info += "    <th>" + resolution + "</th>";
	product_info += "  </tr>";
	product_info += "  <tr>";
	product_info += "    <th>3D</th>";
	product_info += "    <th>" + std::to_string(has_3D) + "</th>";
	product_info += "  </tr>";
	product_info += "  <tr>";
	product_info += "    <th>HDR</th>";
	product_info += "    <th>" + std::to_string(has_HDR) + "</th>";
	product_info += "  </tr>";
	return product_info;
}
