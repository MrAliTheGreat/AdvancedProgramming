...
std::string Car::get_product_info_html(){
	...
	product_info += "  </tr>";
	product_info += "  <tr>";
	product_info += "    <th>Num. of Seats</th>";
	product_info += "    <th>" + std::to_string(num_seats) + "</th>";
	product_info += "  </tr>";
	product_info += "  <tr>";
	product_info += "    <th>Num. of Cylinders</th>";
	product_info += "    <th>" + std::to_string(num_cylinders) + "</th>";
	product_info += "  </tr>";
	product_info += "  <tr>";
	product_info += "    <th>Engine Capacity</th>";
	product_info += "    <th>" + std::to_string(engin_capacity) + "</th>";
	product_info += "  </tr>";
	product_info += "  <tr>";
	product_info += "    <th>Reverse Parking Sensors</th>";
	product_info += "    <th>" + std::to_string(has_park_sensors) + "</th>";
	product_info += "  </tr>";
	return product_info;
}
